                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Card className="bg-slate-950/40 border-white/5 flex flex-col justify-center items-center p-6 space-y-4">
                            ...
                            <div className="text-center">
                                <p className="text-[10px] font-black uppercase text-slate-500 tracking-widest mb-1">Total de Escaneos (Session)</p>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card className="bg-slate-950/50 border-white/5 backdrop-blur-xl h-full flex flex-col">
                        <CardHeader className="pb-4">
                            ...
                            <CardDescription className="text-[9px] uppercase font-bold text-slate-500">Acumulado en Tiempo Real</CardDescription>
                        </CardHeader>
